              ...
              <div key={product.id} className="flex gap-4 p-4 rounded-xl border bg-white shadow-sm">
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="font-bold text-lg" suppressHydrationWarning>₹{(product.pricePerMeter * quantity).toLocaleString('en-IN')}</div>
                  </div>
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center border rounded-md">
                        <Button variant="ghost" size="icon" className="h-8 w-8 rounded-none" aria-label="Decrease quantity" onClick={() => updateQuantity(product.id, quantity - 100)}>
                          <Minus className="h-3 w-3" />
                        </Button>
                        <div className="w-12 text-center text-sm font-medium">{quantity}</div>
                        <Button variant="ghost" size="icon" className="h-8 w-8 rounded-none" aria-label="Increase quantity" onClick={() => updateQuantity(product.id, quantity + 100)}>
