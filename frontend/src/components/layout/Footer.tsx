        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/knowledge" className="hover:text-primary transition-colors">Textile Certifications</Link></li>
              <li><Link href="/knowledge" className="hover:text-primary transition-colors">Support & FAQ</Link></li>
            </ul>
          </div>
          <div>
